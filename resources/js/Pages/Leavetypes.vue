    ...
    <AuthenticatedLayout>
        <div class="py-4">
            <div class="max-w-6xl sm:px-3 lg:px-8">
                <div class="flex justify-end mb-4"><PrimaryButton :href="route('leavetypeform')">Add New Leave Type</PrimaryButton></div>
                <div class="bg-white border border-gray-300 p-8 rounded-lg mb-4">
                    <DataTable v-model:filters="filters" v-model:selection="selectedCustomers" :value="customers" paginator :rows="10" dataKey="id" filterDisplay="menu"
                        ...
                        <Column header="Type" sortable sortField="country.name" filterField="country.name" style="min-width: 10rem; font-size: 0.75rem">
                            <template #body="{ data }">
