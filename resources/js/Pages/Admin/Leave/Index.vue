            ...
            <table class="w-full table-auto">
              ...
              <tbody>
                <tr v-for="leave in filteredLeaves" :key="leave.id" class="bg-white border-b">
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ leave.employeeLeave.type }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ leave.employeeLeave.start_date }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ leave.employeeLeave.end_date }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ leave.employeeLeave.reason }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ leave.employeeLeave.user.name }}</td>
                </tr>
              </tbody>
            </table>
